...
(Add theory from `inla.doc("rw2")` here)
...
```{r, fig.cap = "\\label{fig:credible_interval} (Write comment here)"}
...
posterior_median %>%
  ...
  xlab("Smoking percentage") +
  ylab("Effect")
```

(Comment on figure \ref{fig:credible_interval})

(Desribe how DIC is connected to the degree of trend in this plot)
